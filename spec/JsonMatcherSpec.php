...
class JsonMatcherSpec extends ObjectBehavior
{
    ...
    public function it_matches_that_json_path_not_exists()
    {
    ...
    public function it_fails_on_wrong_ammount_of_items()
    {
        $this->setSubject(('[1,null]'))->shouldThrow()->duringHasSize(3);
    }

    public function it_matches_size_in_nagative_scenarios()
    {
    ...
    public function it_matches_an_subset_included_in_a_hash()
    {
        $json = '{"id": 1, "name": "Foo"}';
    ...
    public function it_should_throw_exception_if_it_cant_find_subset_in_hash()
    {
        $json = '{"id": 1, "name": "Foo"}';
